...
[![Database Schema Visuals](./images/schema_thumbnail.png)](./database%20travel%20schema.mp4)
*Click the image above to view the video of the travel database schema.*
